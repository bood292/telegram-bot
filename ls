_L_S(1)                                                 User Commands                                                 _L_S(1)
...
DDEESSCCRRIIPPTTIIOONN
       List  information about the FILEs (the current directory by default).  Sort entries alphabetically if none of --ccff‐‐
       ttuuvvSSUUXX nor ----ssoorrtt is specified.
       ...
       --cc     with --lltt: sort by, and show, ctime (time of last change of file status information); with  --ll:  show  ctime
       ...
       --FF, ----ccllaassssiiffyy[=_W_H_E_N]
       ...
       ----ffoorrmmaatt=_W_O_R_D
              across,horizontal (--xx), commas (--mm), long (--ll), single-column (--11), verbose (--ll), vertical (--CC)
       ...
       ----iinnddiiccaattoorr--ssttyyllee=_W_O_R_D
              append indicator with style WORD to entry names: none (default), slash (--pp), file-type (----ffiillee--ttyyppee), clas‐
              sify (--FF)
       ...
       --kk, ----kkiibbiibbyytteess
              default to 1024-byte blocks for file system usage; used only with --ss and per directory totals
       ...
       ----ssoorrtt=_W_O_R_D
              change default 'name' sort to WORD: none (--UU), size (--SS), time (--tt), version (--vv),  extension  (--XX),  name,
              width

       ----ttiimmee=_W_O_R_D
              select  which timestamp used to display or sort; access time (--uu): atime, access, use; metadata change time
              (--cc): ctime, status; modified time (default): mtime, modification; birth time: birth, creation;
       ...
       --uu     with --lltt: sort by, and show, access time; with --ll: show access time and sort by name;  otherwise:  sort  by
              access time, newest first

       --UU     do not sort directory entries
       ...
       ----zzeerroo end each output line with NUL, not newline
       ...
       ddaattee(1).   If  FORMAT  is  FORMAT1<newline>FORMAT2, then FORMAT1 applies to non-recent files and FORMAT2 to recent
       ...
       Using  color  to distinguish file types is disabled both by default and with ----ccoolloorr=_n_e_v_e_r.  With ----ccoolloorr=_a_u_t_o, ls
       emits color codes only when standard output is connected to a terminal.  The LS_COLORS  environment  variable  can
       change the settings.  Use the ddiirrccoolloorrss(1) command to set it.
...
GNU coreutils 9.7                                       June 2025                                                   _L_S(1)
